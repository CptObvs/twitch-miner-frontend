    ...
    <div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 px-4">
      ...
      <div class="relative w-full max-w-sm space-y-6">
        <div class="text-center">
          ...
          <h1 class="text-3xl font-bold bg-gradient-to-r from-twitch-light via-twitch to-twitch-dark bg-clip-text text-transparent">Twitch Miner</h1>
        ...
        <p class="text-center text-sm text-gray-400">
          ...
          <a routerLink="/register" class="font-medium text-twitch-light transition-colors hover:text-twitch hover:underline">Register</a>
        </p>
      </div>
    </div>
  `,
