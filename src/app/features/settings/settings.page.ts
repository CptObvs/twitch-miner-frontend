  ...
  template: `
    <div class="mx-auto max-w-2xl">
      <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 rounded-2xl border border-gray-800 bg-gray-900/60 backdrop-blur-xl px-3 py-2 shadow-lg shadow-black/20">
          <div class="flex items-center gap-2 rounded-xl bg-gray-800/70 border border-gray-700/50 px-2.5 py-1.5">
            <svg class="h-4 w-4 text-twitch-light" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <!-- Change Password -->
      <div class="rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800/50 backdrop-blur-xl p-5 shadow-xl shadow-black/20">
        ...
        <form [formGroup]="passwordForm" (ngSubmit)="changePassword()">
          <div class="space-y-3">
            ...
            @if (error()) {
              <div class="rounded-xl bg-red-900/50 border border-red-700/50 p-4 text-sm text-red-300 shadow-lg shadow-red-900/20" role="alert">
            ...
            @if (success()) {
              <div class="rounded-xl bg-green-900/50 border border-green-700/50 p-4 text-sm text-green-300 shadow-lg shadow-green-900/20" role="alert">
                <div class="flex items-center gap-2">
                  <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
export class SettingsPage {
  ...
  async changePassword() {
    ...
    try {
      ...
      if (error) {
        this.error.set(
          typeof error.detail === 'string' ? error.detail : 'Failed to change password',
        );
      } else {
