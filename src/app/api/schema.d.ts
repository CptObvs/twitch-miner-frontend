...
export interface paths {
  ...
  '/instances/{instance_id}': {
    ...
    /**
     * Delete Instance
     * @description Stop container (if running) then delete DB record.
     */
  ...
  '/instances/{instance_id}/stop': {
    ...
    /**
     * Stop Instance
     * @description Stop the Docker container. Blocks until fully stopped.
     */
  ...
  '/instances/{instance_id}/status': {
    ...
    /**
     * Instance Status
     * @description Live-check container status against Docker, then return DB state.
     */
  ...
  '/instances/{instance_id}/logs': {
    ...
    /**
     * Stream Logs
     * @description SSE endpoint — streams Docker container logs in real-time.
     *
...
export interface components {
  schemas: {
    ...
    InstanceCreate: {
      /** @default docker */
      miner_type?: 'docker' | 'subprocess';
      /** Required for subprocess miner type */
    ...
    InstanceResponse: {
      ...
      /** Container Id (docker only) */
      container_id?: string | null;
      /** Port (docker only) */
      port?: number | null;
      /** Ui Url (docker only) */
      ui_url?: string | null;
      /** Twitch Username (subprocess only) */
      twitch_username?: string | null;
      /** PID (subprocess only) */
      pid?: number | null;
      /** Enable Analytics (subprocess only) */
      enable_analytics?: boolean;
      /** Analytics Port (subprocess only) */
      analytics_port?: number | null;
      /** Activation Code (subprocess only, ephemeral) */
      activation_code?: string | null;
      /** Activation URL (subprocess only, ephemeral) */
    ...
    InstanceStatus: {
      ...
      /** PID (subprocess only) */
      pid?: number | null;
      /** Activation URL (subprocess only) */
      activation_url?: string | null;
      /** Activation Code (subprocess only) */
      activation_code?: string | null;
    };
    /** StreamersUpdate */
    StreamersUpdate: {
...
export interface operations {
  ...
  get_streamers_instances__instance_id__streamers_get: {
    ...
    responses: {
      200: {
        headers: { [name: string]: unknown };
        content: { 'application/json': { streamers: string[] } };
      };
    };
  };
  update_streamers_instances__instance_id__streamers_put: {
    ...
    requestBody: {
      content: { 'application/json': components['schemas']['StreamersUpdate'] };
    };
    responses: {
      200: {
        headers: { [name: string]: unknown };
