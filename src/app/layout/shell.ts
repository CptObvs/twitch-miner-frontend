...
@Component({
  ...
  imports: [RouterOutlet, RouterLink, RouterLinkActive, SidebarInvite],
  template: `
      ...
      >
        ...
        <div class="border-t border-gray-800 p-3 space-y-2">
          ...
          <div class="flex items-center gap-2 px-2 pt-1">
            <a
              href="https://github.com/CptObvs/twitch-miner-frontend"
              target="_blank"
              rel="noopener noreferrer"
              class="group flex items-center gap-1.5 rounded-lg px-2 py-1 text-xs text-gray-500 transition-colors hover:text-gray-300 hover:bg-gray-800/50"
            ...
            <a
              href="https://github.com/rdavydov/Twitch-Channel-Points-Miner-v2"
              target="_blank"
              rel="noopener noreferrer"
              class="group flex items-center gap-1.5 rounded-lg px-2 py-1 text-xs text-gray-500 transition-colors hover:text-gray-300 hover:bg-gray-800/50"
              title="Miner Repository"
            >
              <svg
                class="h-3.5 w-3.5"
                fill="currentColor"
